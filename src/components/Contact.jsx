...
const Contact = () => {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send(
      'dennisvandenberg13100', 
      'template_wyhfo2s',
      {
        from_name: form.name,
        to_name: 'Dennis', 
        from_email: form.email,
        to_email: 'dennisvandenberg13100@gmail.com',
        message: form.message
      },
      '2JBCFwcInmnMhzHe7'
      ).then(() => {
        setLoading(false);
        alert("Obrigado por entrar em contato, responderei seu e-mail assim que possível.")
        setForm({
          name:'',
          email:'',
          message:''
        ...
        >
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message} 
              onChange={handleChange}
              placeholder="O que deseja me contar?"
              className="bg-tertiary py-4 px-6 placeholder:text-secondary text-white rounded-lg outline-none font-medium"
            />
          </label>
